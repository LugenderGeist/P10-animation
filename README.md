...
(*В силу того, что частота, с которой снимает телефон не совпадает с частотой обновления матрицы - кажется, что изображение рябит.  
На самом деле все намного лучше. Куб вращается немного в странной плоскости, но это так и задумано.*)
